...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-primary hover:bg-green-400 text-white shadow-lg hover:shadow-primary/50',
    secondary: 'bg-card hover:bg-input text-white',
    error: 'bg-error hover:bg-red-400 text-white shadow-lg',
